 ...
 * @since Apr 28, 2003$
 */
public class FlatXmlDataSetProviderTest extends FlatXmlDataSetTest
{
    public FlatXmlDataSetProviderTest(String s)
    {
        super(s);
    }
    ...
    protected IDataSet createDataSet() throws Exception
    {
        ...
        return new CachedDataSet(new FlatXmlProvider(source));
    }
    ...
    public void testMissingColumnAndEnableDtdMetadata() throws Exception
    {
        ...
        IDataSet dataSet = new CachedDataSet(new FlatXmlProvider(source));
    ...
    public void testMissingColumnAndDisableDtdMetadata() throws Exception
    {
        File file = new File("src/xml/flatXmlTableTest.xml");
        InputSource source = new InputSource(file.toURL().toString());
        FlatXmlProvider provider = new FlatXmlProvider(source, true);
